    ...
    <div className="max-w-screen-xl mx-auto">
      <div className="py-10 container mx-auto">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-10 max-w-screen-md mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white shadow-md rounded-lg p-6 border border-gray-200">
              ...
              <p className="text-gray-600">
                ...
                patients by providing an intuitive platform
                to search, book, and manage medical
            ...
            <div className="bg-white shadow-md rounded-lg p-6 border border-gray-200">
              ...
              <p className="text-gray-600">
                To create a healthier world where everyone
                has access to quality medical care at their
                fingertips.
              </p>
            </div>
          ...
          <div className="mt-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              ...
              seamless booking processes, we are committed
              to enhancing your healthcare experience.
            </p>
          </div>
        </div>
      </div>
